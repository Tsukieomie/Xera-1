...
### Effect of E-017 through E-030 on the ledger
...
5. **NARA Catalog API follow-up (E-030).** A 2026-05-02 curl probe of `catalog.archives.gov` v1 search and v1-by-naId endpoints with `Accept: application/json` still returns the single-page-app HTML shell rather than JSON payloads, consistent with E-012. No new accession metadata was retrieved; archival closure remains on human NARA / USPTO channels already listed in `ARCHIVAL_TARGETS_756124.md`.
