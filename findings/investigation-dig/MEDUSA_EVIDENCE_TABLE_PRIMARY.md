...
| USAspending standard search cannot directly cover this contract period | API message from `spending_by_award`: earliest query start date is `2007-10-01`; `M67854-04-C-1012` is 2003-2004 | API boundary evidence | T3 method caveat | High | Explains why normal API search can miss this record; use Custom Award Download / bulk download pathways for pre-2007 reconciliation. |
