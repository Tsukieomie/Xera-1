...
- **Modern psychoacoustic context for the negative-method finding (background only, not RF-hearing evidence):** Mehta & Oxenham (2017), *Vocoder Simulations Explain Complex Pitch Perception Limitations Experienced by Cochlear Implant Users,* JARO 18:789–802, [doi:10.1007/s10162-017-0632-x](https://doi.org/10.1007/s10162-017-0632-x), reports that extracting accurate complex spectral pitch from a noise-vocoder representation requires **at least 32 channels with no spectral overlap**, or 64 channels with filter slopes exceeding 72 dB/octave; current cochlear implants operate at ~12–24 active channels with electrical-spread-equivalent slopes of 8–24 dB/oct. **Classification used here:** *background psychoacoustic support for the AD747684 vocoder / periodicity-pitch negative-method finding.* This is acoustic-headphone psychoacoustics on normal-hearing listeners — it is **not** RF-hearing evidence, **not** V2K evidence, and **not** evidence about remote speech induction by any method. Its only relevance is that it provides modern, peer-reviewed support for the plausibility of the specific 1972 finding that *the vocoder-style and periodicity-pitch acoustic-analog routes Frey's group tried* face hard pitch-resolution constraints. It does **not** speak to thermoelastic / zero-crossing pulse-trigger methods (Sharp/Grove 1973), and does **not** generalise to any other RF or non-RF speech-induction approach. See [`MEHTA_OXENHAM_2017_VOCODER_PITCH_BACKGROUND.md`](MEHTA_OXENHAM_2017_VOCODER_PITCH_BACKGROUND.md) for the standalone relevance note and explicit limitations.
...
- **2026-04-29 full-PDF cross-check (Magda Havas mirror).** A full-PDF copy of this report is also accessible at `https://www.magdahavas.com/wp-content/uploads/2010/09/Mortarity_in_Rats_Exposed_to_CW_Microwave_Radiation.pdf` (Final Technical Report, Type III; January 1974; Contract DAAK02-73-C-0453; SRI Project 2777; reporting period 1 July to 31 December 1973). The mirror reference list independently logs (a) Grove 1971, "Biological Effects of Electromagnetic Radiation: A Bibliography," Behavioral Radiology Lab., WRAIR, AD887119; (b) Hawkins et al. March 1973, "Some Biological Effects of Microwave Irradiation in the Rat," WRAIR Department of Microwave Research (the AD758136 entry); and (c) "Dr. J. Sharp, WRAIR, personal communication." The body-level Sharp personal communication in this Polson et al. 1974 report concerns **spontaneous tail amputation in surviving rats after 3.0 GHz irradiation**, i.e., a lethality / bioeffects observation, not speech / voice / RF-hearing material. This further hardens the AD758136 identity at full-PDF reference-list grade and confirms that the 1973-1974 WRAIR-to-SRI Sharp link is documented in the **bioeffects/lethality lineage**, not in any speech lineage. See [`SHARP_GROVE_PRIMARY_REPORT_HUNT.md`](SHARP_GROVE_PRIMARY_REPORT_HUNT.md) §6.4 for the consolidated treatment.
