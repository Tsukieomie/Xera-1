...
- **Live record:** [NTRL titleDetail / AD747684](https://ntrl.ntis.gov/NTRL/dashboard/searchResults/titleDetail/AD747684.xhtml).
...
- **Sharp, Grove, Gandhi (1974), IEEE TMTT 22:583–584.** DOI [10.1109/TMTT.1974.1128293](https://doi.org/10.1109/TMTT.1974.1128293). Mechanism / acoustic-signal generation by pulsed microwave energy in absorbers and aluminium-foil targets. **Mechanism paper, not speech protocol.** Already in repo as `findings/investigation-dig/sharp-grove-gandhi-1974.pdf`.
- **Justesen (1975), American Psychologist 30: 391–401.** Source of the popularised "Sharp & Grove" pairing. Justesen's account of the WRAIR voice-modulated-microwave demo is **a published account based on a personal communication from Sharp**, not a located primary protocol report. This continues to be the single most important citation-hygiene caveat across the V2K chain.
...
- **No operational speech protocol has been located in this pass.** The protocol-grade T2 question — power level, modulation, intelligibility scoring, blinding, transcripts — remains open. Justesen 1975 American Psychologist remains a published account based on personal communication from Sharp, not a located primary protocol report.
