...
- **2026-05-02 follow-on Solr (still zero):** `title:(("Annual Progress") AND ("30 June 1975"))` → `numFound: 0`; `title:(("Walter Reed Army Institute") AND "1975")` → `numFound: 0` (no alternate titling stub for the gap year on IA’s indexed DTIC mirror).
